...
const Contacto = () => {
  return (
    ...
    <div id="contacto" className="flex justify-center my-10 items-center">
      <div className="w-full max-w-lg p-4   rounded-lg shadow sm:p-8 bg-gray-800 text-gray-300 ">
        <label
          htmlFor="nombre"
        ...
        <input
          type="text"
          id="nombre"
          className=" mb-2     text-sm rounded-lg   block w-full p-2.5 bg-gray-700 placeholder-gray-400    "
        ...
        <textarea
          id="message"
          rows={4}
          className="mb-8 block p-2.5 w-full text-sm   rounded-lg     bg-gray-700 placeholder-gray-400  "
