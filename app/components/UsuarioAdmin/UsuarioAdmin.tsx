            ...
            <ul className=" md:p-10 p-5 space-y-1  text-gray-400 text-left  ">
              <dl className="max-w-md  divide-y  text-gray-200 divide-gray-700">
                ...
                <div className="flex flex-col py-3">
                  ...
                  <dd className="text-sm font-semibold">
                    Avenida Boulevard Louis Pasteur 9, Málaga, España (29010)
                  </dd>
                </div>
              ...
              <table className="w-full text-sm text-left rtl:text-right  text-gray-400 bg-gray-900 mb-3">
                ...
                <tbody>
                  <tr className=" border-b bg-gray-800 border-gray-700  ">
                    ...
                    >
                      Perro sentado en frente de un bosque lleno de vegetación y
                      fauna
                    </th>
                  ...
                  <tr className=" border-b bg-gray-800 border-gray-700 ">
                    <th
                      ...
                      className="px-6 py-4 font-medium dwhitespace-nowrap text-gray-300"
                    >
                      Descubre el mundo lápiz en mano y deja que tus sueños sean
                      tu brújula
                    </th>
                    <td className="px-6 py-4"></td>
                    <td className="px-6 py-4"></td>
